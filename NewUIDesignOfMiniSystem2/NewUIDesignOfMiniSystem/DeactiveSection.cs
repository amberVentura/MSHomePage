...
namespace NewUIDesignOfMiniSystem
{
    public partial class DeactiveSection : Form
    {
        ...
        private void bRSearch_Click(object sender, EventArgs e)
        {
            ...
            string RFirstName = tbRFirstName.Text?.Trim();
            string RLastName = tbRLastName.Text?.Trim();
            ...
            else if (!string.IsNullOrWhiteSpace(RFirstName))
            {
                found = AppointmentRecords.FirstOrDefault(r =>
                    r.FirstName.Equals(RFirstName, StringComparison.OrdinalIgnoreCase));
            }
            else if (!string.IsNullOrWhiteSpace(RLastName))
            {
                found = AppointmentRecords.FirstOrDefault(r =>
                    r.LastName.Equals(RLastName, StringComparison.OrdinalIgnoreCase));
            }
        ...
        private void bRDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                MessageBox.Show("Record deactive successfully.");
                found = null;
