...
namespace NewUIDesignOfMiniSystem
{
    public partial class Login : Form
    {
        ...
        public Login(BindingList<Appointment.Record> appointmentRecords, Billings billingsForm, BindingList<Record> deletedRecords)
        {
            InitializeComponent();
            LoadAdmins();
        ...
        private void bLogin_Click(object sender, EventArgs e)
        {
            ...
            if (adminList.ContainsKey(user))
            {
                ...
                if (saveHash == inputHash)
                {
                    ...
                    MainPage main = new MainPage(AppointmentRecords,billingsForm,DeletedRecords); // Lalabas bigla yung homepage 
                    main.Show();
                    this.Hide();
                }
                else
